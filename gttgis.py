...
#
# Created: Mon Sep 04 14:47:59 2017
...
""))
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, -156, 262, 971))
...
"}"))
        ...
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.g_estadisticas.sizePolicy().hasHeightForWidth())
        self.g_estadisticas.setSizePolicy(sizePolicy)
        self.g_estadisticas.setMinimumSize(QtCore.QSize(0, 0))
        self.g_estadisticas.setMaximumSize(QtCore.QSize(16777215, 16777215))
        self.g_estadisticas.setObjectName(_fromUtf8("g_estadisticas"))
        self.gridLayout = QtGui.QGridLayout(self.g_estadisticas)
        self.gridLayout.setContentsMargins(0, 0, 0, 8)
        self.gridLayout.setHorizontalSpacing(0)
        self.gridLayout.setVerticalSpacing(6)
        self.gridLayout.setObjectName(_fromUtf8("gridLayout"))
        self.statDesc = QtGui.QPushButton(self.g_estadisticas)
        self.statDesc.setMinimumSize(QtCore.QSize(100, 30))
        self.statDesc.setMaximumSize(QtCore.QSize(100, 16777215))
        icon15 = QtGui.QIcon()
        icon15.addPixmap(QtGui.QPixmap(_fromUtf8(":/icons/desconocido.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.statDesc.setIcon(icon15)
        self.statDesc.setObjectName(_fromUtf8("statDesc"))
        self.gridLayout.addWidget(self.statDesc, 1, 0, 1, 1)
        self.cb_stats = QtGui.QComboBox(self.g_estadisticas)
        self.cb_stats.setMinimumSize(QtCore.QSize(103, 0))
        self.cb_stats.setObjectName(_fromUtf8("cb_stats"))
        self.gridLayout.addWidget(self.cb_stats, 0, 0, 1, 2)
        self.statExport = QtGui.QPushButton(self.g_estadisticas)
        self.statExport.setMinimumSize(QtCore.QSize(100, 30))
        self.statExport.setMaximumSize(QtCore.QSize(100, 16777215))
        icon16 = QtGui.QIcon()
        icon16.addPixmap(QtGui.QPixmap(_fromUtf8(":/img/exportar")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.statExport.setIcon(icon16)
        self.statExport.setObjectName(_fromUtf8("statExport"))
        self.gridLayout.addWidget(self.statExport, 1, 1, 1, 1)
        self.lshp = QtGui.QPushButton(self.g_estadisticas)
        self.lshp.setMinimumSize(QtCore.QSize(100, 30))
        self.lshp.setMaximumSize(QtCore.QSize(100, 16777215))
        self.lshp.setIcon(icon16)
        self.lshp.setObjectName(_fromUtf8("lshp"))
        self.gridLayout.addWidget(self.lshp, 2, 1, 1, 1)
        self.tablaDesc = QtGui.QPushButton(self.g_estadisticas)
        self.tablaDesc.setMinimumSize(QtCore.QSize(100, 30))
        self.tablaDesc.setMaximumSize(QtCore.QSize(100, 16777215))
        icon17 = QtGui.QIcon()
        icon17.addPixmap(QtGui.QPixmap(_fromUtf8(":/icons/tabla.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.tablaDesc.setIcon(icon17)
        self.tablaDesc.setObjectName(_fromUtf8("tablaDesc"))
        self.gridLayout.addWidget(self.tablaDesc, 2, 0, 1, 1)
        self.AnaDesc = QtGui.QPushButton(self.g_estadisticas)
        self.AnaDesc.setMinimumSize(QtCore.QSize(100, 30))
        self.AnaDesc.setMaximumSize(QtCore.QSize(100, 16777215))
        self.AnaDesc.setIcon(icon17)
        self.AnaDesc.setObjectName(_fromUtf8("AnaDesc"))
        self.gridLayout.addWidget(self.AnaDesc, 3, 0, 1, 1)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.c_estadisticas.setText(_translate("MainWindow", "ESTADÍSTICAS / EXPORTAR", None))
        self.statDesc.setText(_translate("MainWindow", "Desconocidos", None))
        self.statExport.setText(_translate("MainWindow", "Exportar", None))
        self.lshp.setText(_translate("MainWindow", "SHP", None))
        self.tablaDesc.setText(_translate("MainWindow", "Desconocidos", None))
        self.AnaDesc.setText(_translate("MainWindow", "     Análisis", None))
